            ...
            <td>
                <table class="table table-hover text-center">
                    ...
                    <form name="form3" method="post" action="article_column.php" onSubmit="return chkinput3( this)">
                        <tr>
                            <td><div align="center">专家姓名:<input type="text" name="username" class="inputcss" >
                                    专家ID:<input type="text" name="ddh" size="25" class="inputcss" ></div></td>
                        </tr>
                        <tr>
                            <td height="25">
                                <div align="center">
        ...
        <table class="table table-hover text-center">
            ...
            <tr>
                <td >
                    <table class="table table-hover text-center">
                        <tr>
                            <!--                        <td ><div align="center">栏目姓名</div></td>-->
                            <td ><div align="center">专家ID</div></td>
                            <td ><div align="center">专家标题</div></td>
...
<form name="form1" method="post" action="deleteArticleHelp.php">
    <table class="table table-hover text-center">
        <tr>
            <td><div align="center" class="style1">全部专家信息</div></td>
        </tr>
        <tr>
