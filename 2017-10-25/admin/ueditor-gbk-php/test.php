...
<div>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input name="url" type="text" size="80"  value="<?php echo $rs['url'];?>"/>
                (如果要跳向URL网址,请输入网址,否则请留空，跳转必须加: http://)</td>
        </tr>
        <tr>
            <td></td>
    ...
    <!--        --><?php
    //        $sql= "select * from n_find_cn where id='".$_GET['id']."'";  //获取对应的结果集需要写where id =where id='".$_GET['id']."',否则无法读取成功
...
<div id="btns">
    <div>
        ...
        <!--        <input type="submit" name="Submit" value="确认提交" onclick="getContent()"/>-->
